...
function changeBackgroundPattern() {
	...
	// backgrounds
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="'+base_url+'css/backgrounds/'+get_cookie1+'.css">');
	...
	$(".switcher > .switcher-content > .pattern-switch").find('a').bind('click', function(e) {
		...
		$('head')
		.append('<link rel="stylesheet" id="active-bg" href="'+base_url+'css/backgrounds/'+bgName+'.css">');
	});
}
